...
const AboutUs = () => {
  return (
    <div className="container-fluid">
      ...
      <a href="mailto:politicalcures@gmail.com">politicalcures@gmail.com</a> with SCOOP in the 
      subject line. </p>
      <hr />

      <h3>Send us a blog-pitch or another Political Solution</h3>
      <p>
        Contact us at&nbsp;<a href="mailto:politicalcures@gmail.com">politicalcures@gmail.com</a>
        to pitch an idea for a blog post to the PoliCure blog team.
      </p>
      <hr />

      <h3>Advertise on PoliCure.com</h3>
      <p>Contact us at&nbsp;<a href="mailto:politicalcures@gmail.com">politicalcures@gmail.com</a>
      ...
      <a href="mailto:politicalcures@gmail.com">politicalcures@gmail.com</a> to help us solve real world
